...
| 2026/03/07 | v2.5.6 | PWAアイコン追加（ハートデザイン）。ホーム画面追加時にカラーアイコン表示。スマホ時の都道府県ドロップダウンを画面中央に固定表示 | エーデル |
| 2026/03/07 | v2.5.7 | 複数施設ヒット時のUI統一（病院名のみ表示・クリックで詳細）。📋コピー / 📥CSV / 📊Excel / 💬LINE共有ボタンを追加 | エーデル |
